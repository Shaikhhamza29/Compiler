...
class MainActivity : AppCompatActivity() {
    ...
    val JDOODLE_CLIENT_ID = "885af096d46cc2661c215ee95d53954d"
    val JDOODLE_CLIENT_SECRET = "4e1c87c70f3f2fd5841f98b5460c29af65912290a1cabe2cc369a3d06b37db5d"
    ...
    private fun compileCode(language: String, code: String, callback: (String) -> Unit) {
        ...
        val requestBody = JSONObject().apply {
            ...
            put("versionIndex", "0")
            put("clientId", JDOODLE_CLIENT_ID)
            put("clientSecret", JDOODLE_CLIENT_SECRET)
        }
